...
jQuery(function($){
    $(".sns-wrap").on("click", "a.social_link", function(e){
        ...
        if(!newWin || newWin.closed || typeof newWin.closed == 'undefined') {
            alert(decodeURIComponent('%EB%B8%8C%EB%9D%BC%EC%9A%B0%EC%A0%80%EC%97%90%EC%84%9C%20%ED%8C%9D%EC%97%85%EC%B0%BD%EC%9D%B4%20%EC%B0%A8%EB%8B%A8%EB%90%98%EC%96%B4%20%EC%9E%88%EC%8A%B5%EB%8B%88%EB%8B%A4.%20%ED%8C%9D%EC%97%85%20%EC%B0%A8%EB%8B%A8%EC%9D%84%20%ED%95%B4%EC%A0%9C%ED%95%9C%20%ED%9B%84%20%EB%8B%A4%EC%8B%9C%20%EC%8B%9C%EB%8F%84%ED%95%B4%20%EC%A3%BC%EC%84%B8%EC%9A%94.'));
        }
...
@media (max-width:480px){
    #mb_login.login-page{padding:16px}
    #mb_login .login-card{padding:20px 16px;border-radius:20px}
    #mb_login .login-links{flex-direction:column;align-items:flex-start}
}

/* 카카오 SNS 로그인 버튼 반응형 보정 */
#sns_login {
    width: 100%;
    margin: 20px 0;
    text-align: center;
...
#sns_login .sns-icon.sns-kakao .ico {
    display: inline-block;
    width: 22px;
    height: 22px;
    margin-right: 8px;
    flex: 0 0 auto;
    background:url('<?php echo G5_IMG_URL; ?>/kakao.png') no-repeat center;
    background-size:contain;
}

#sns_login .sns-icon.sns-kakao .txt {
    display: inline-block;
    line-height: 1.3;
    white-space: normal;
    word-break: keep-all;
...
#sns_login .sns-icon.sns-kakao .txt i {
    font-style: normal;
}
