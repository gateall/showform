...
<section id="bo_w">
    ...
    <div class="write_div">
        ...
        <div class="wr_content <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
            ...
            <?php } ?>
            <?php if ($is_dhtml_editor && !empty($editor_html)) { ?>
            <?php echo $editor_html; // 에디터 사용시 에디터 출력 ?>
            <?php } else { ?>
            <textarea id="wr_content" name="wr_content" class="frm_input" maxlength="65536" style="width:100%;height:360px;"><?php echo $content; ?></textarea>
            <?php } ?>
            <?php if($write_min || $write_max) { ?>
            <!-- 최소/최대 글자 수 사용 시 -->
