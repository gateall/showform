...
$phone_num = isset($knu_brand['phone']) ? $knu_brand['phone'] : '1844-****';
$phone_link = isset($knu_brand['phone_link']) ? $knu_brand['phone_link'] : 'tel:1844-****';
...
<section class="knu-section" id="knuCtaFinal">
    <div class="knu-container knu-cta-wrap" data-knu-fade="data-knu-fade">
        ...
        <h3>이사 고민, 미루지 말고 지금 인터넷2424와 상담하세요</h3>
        <p>전화 상담부터 방문 견적 안내까지 빠르고 친절하게 도와드립니다.<br>전화상담과 온라인접수 모두 가능합니다.</p>

        <div class="knu-cta-tel-box">
            <a href="<?php echo $phone_link; ?>" class="cta-tel"><?php echo $phone_num; ?></a>
            <span class="knu-cta-note">연중무휴 · 무료 방문 견적 · 책임 이사</span>
        </div>
        ...
        <div class="knu-cta-proof">
            <div class="knu-proof-card">
                <div class="card-text">
                    ...
                    <h4>포장이사 전문 서비스 인증</h4>
                    <p>안전한 운송과 성실한 마무리를 약속합니다</p>
                </div>
                <div class="card-img">
