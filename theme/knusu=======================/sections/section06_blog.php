...
$blog_cards = array(
    array(
        'title' => '이사 현장 스케치',
        'tag' => '생생한 이사 현장',
        'desc' => '인터넷2424의 전문적인 포장부터 안전한 운송, 깔끔한 마무리까지 현장의 모습을 담았습니다.',
        'link_text' => '현장 스케치 보기',
    ...
    array(
        'title' => '이사 준비 및 정보',
        'tag' => '이사 체크리스트',
        'desc' => '이사 전 확인해야 할 사항, 포장 팁, 유용한 정보를 이해하기 쉽게 정리한 칼럼입니다.',
        'link_text' => '정보 더보기',
    ...
    array(
        'title' => '고객 이사 후기',
        'tag' => '100% 리얼 후기',
        'desc' => '실제 고객님들이 직접 남겨주신 솔직한 인터넷2424 이용 후기를 확인해보세요.',
        'link_text' => '후기 보러가기',
...
<section class="knu-section" id="knuBlog">
    <div class="knu-container">
        <div class="knu-sec-head" data-knu-fade="data-knu-fade">
            ...
            <h3>공식 블로그 소식 및 현장 이야기</h3>
            <p>다양한 이사 현장 스케치, 이사 준비 팁, 고객 리얼 후기 등<br>인터넷2424의 생생한 소식을 직접 확인해보세요.</p>
        </div>
