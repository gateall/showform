...
?>
<meta name="description" content="인터넷2424 포장이사, 일반이사, 사무실이사, 보관이사 전문업체">
<meta name="keywords" content="인터넷2424, 포장이사, 일반이사, 사무실이사, 보관이사, 원룸이사, 기업이사">
<title>인터넷2424 - 포장이사·일반이사·사무실이사 전문업체</title>
<?php
$shop_css = '';
...
<?php
// 회원 로그인 메시지 출력 제거 - 화면에 노출되지 않도록 처리
/*
