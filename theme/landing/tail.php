...
$korea_nusu_quick_links = array(
    array(
        'label' => '샘플보기',
        'href' => '/page/landing.php?id=1',
        'icon' => 'consult',
        'external' => false
    ),
    array(
        'label' => '랜딩생성',
        'href' => '/adm/landing/landing_form.php',
        'icon' => 'consult',
        'external' => false
    ),
    array('label' => '관리자', 'href' => G5_ADMIN_URL.'/', 'icon' => 'consult', 'external' => false),
);
...
<style>
    ...
    @media (min-width:681px) {
        ...
        .kn-pc-quick-text-top {
            font-size: 13px;
            font-weight: 800
        }

        .kn-pc-quick-text-sub {
            font-size: 14px;
            font-weight: 900;
            letter-spacing: 0;
            color: #fff
    ...
    <div class="kfooter">
        <div class="kfooter-inner">
            <div class="kfooter-logo">
                <img src="/img/logo.png" alt="AI 랜딩페이지 자동화 시스템 로고">
            </div>
            <div class="kfooter-text">
        <div class="kfooter-menu">
                    <span><a href="/page/landing.php?id=1">샘플보기</a></span>
                    <span><a href="/adm/landing/landing_form.php">랜딩생성</a></span>
                    <span><a href="<?php echo G5_ADMIN_URL; ?>/">관리자</a></span>
                </div>
                <p class="kfooter-info">
                    <span class="line" style="font-weight:bold; font-size:14px; color:#333; margin-bottom:5px;">ShowForm</span>
                    <span class="line">AI 랜딩페이지 자동생성 플랫폼</span>
                    <span class="line">랜딩 자동 생성 · 문의 DB · AI 문구 생성 · 광고 연결</span>
                </p>
                <p class="kfooter-copy">Copyright &copy; ShowForm. All rights reserved.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="kn-pc-quick-list">
        <?php foreach ($korea_nusu_quick_links as $item) { ?>
            <a href="<?php echo $item['href']; ?>" class="kn-pc-quick-item" <?php echo !empty($item['external']) ? ' target="_blank" rel="noopener"' : ''; ?>>
                ...
                <?php if ($item['icon'] === 'phone') { ?>
                    <span class="kn-pc-quick-text kn-pc-quick-text--phone">
                        <span class="kn-pc-quick-text-top">📞 문의상담</span>
                        <span class="kn-pc-quick-text-sub">1800-****</span>
                    </span>
                <?php } else { ?>
