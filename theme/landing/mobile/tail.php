...
$mobile_quick_links = array(
    array('label' => '무료 상담 신청', 'href' => 'tel:010-1234-0000', 'icon' => 'consult', 'target' => ''),
    array('label' => '상담문의', 'href' => 'tel:1844-****', 'icon' => 'phone', 'target' => '')
);
...
<div id="ft">
    <div class="mft-wrap">
        <div class="mft-logo"><img src="/img/logo.png" alt="AI 랜딩페이지 자동화 시스템 로고"></div>
        ...
        <p class="mft-info">
            <span class="line">브랜드명: AI 랜딩페이지 자동화 시스템  대표자: 대표자명  사업자등록번호: 000-00-00000</span><br>
            <span class="line">주소 : 서울시 **구 **동  대표전화 : 1844-****  무료 상담 신청 : 010-1234-0000</span><br>
            <span class="line">이메일: abc@naver.com  통신판매신고번호: 제026-서울-0000호</span>
        </p>
        <p class="mft-copy">Copyright &copy; AI 랜딩페이지 자동화 시스템 All Rights Reserved.</p>
    </div>
...
<nav class="premium-mobile-tabbar" aria-label="모바일 하단 메뉴">
    ...
    <a href="/adm" class="tabbar-item">
        <span class="tabbar-icon">⚙️</span>
        <span class="tabbar-text">관리자</span>
    </a>
</nav>
...
<div id="mobile_consult_bar" class="is-collapsed" aria-label="모바일 상담 바">
    ...
    <div class="mcb-panel">
        <a href="tel:1844-****" class="mcb-call" aria-label="상담문의 1844-****">
