...
// Mobile must load mobile head first when theme-mobile head exists.
if (G5_IS_MOBILE) {
    if (defined('G5_THEME_MOBILE_PATH') && is_file(G5_THEME_MOBILE_PATH.'/head.php')) {
        require_once(G5_THEME_MOBILE_PATH.'/head.php');
        return;
    }
...
if (defined('G5_THEME_PATH') && is_file(G5_THEME_PATH.'/head.php')) {
