...
$menu['menu900'] = array(
    ...
    array('900100', '<i class="fa-solid fa-layer-group"></i> 템플릿관리', G5_ADMIN_URL.'/landing/template_list.php', 'template_list'),
...
$menu['menu910'] = array(
    array('900200', '<span class="sf-menu-inquiry"><i class="fa-solid fa-comments"></i></span> 문의관리', G5_ADMIN_URL.'/landing/inquiry_list.php', 'sf_inquiry'),
