...
CREATE TABLE IF NOT EXISTS `g5_sf_blog_post_performance` (
    ...
    CONSTRAINT `fk_perf_post_target` FOREIGN KEY (`post_target_id`) REFERENCES `g5_sf_blog_post_targets` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 보고서 스냅샷 기록 (report_snapshots) 테이블 (향후 정기 메일/생성 이력 용도)
CREATE TABLE IF NOT EXISTS `g5_sf_blog_report_snapshots` (
    `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
