...
if (
    ...
    !is_file($sql_file_v7) || !is_file($sql_file_v8) || !is_file($sql_file_v9) || !is_file($sql_file_v10) || !is_file($sql_file_v11) || !is_file($sql_file_v12)
) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['run_all']) || $_POST['run_v12'] || !$v12_installed) {
        $created = array_merge($created, bp_install_run_sql_file($sql_file_v12, $table_prefix));
    }
...
$already_installed = $v1_installed && $v2_installed && $v3_installed && $v4_installed && $v5_installed && $v6_installed && $v7_installed && $v8_installed && $v9_installed && $v10_installed && $v11_installed && $v12_installed;
...
<div class="local_desc01 local_desc">
    ...
    &nbsp;&nbsp;Reports/Performance: <?php echo $v12_installed ? '설치됨' : '<span style="color:#c00;">미설치</span>'; ?></p>
</div>
    ...
    <form method="post" action="./install.php">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">V10 (Image Pipeline) DB 업데이트</th>
                    <td>
                ...
                <tr>
                    <th scope="row">V12 (Reports/Performance) DB 업데이트</th>
                    <td>
                        <button type="submit" name="run_v12" value="1" class="btn btn_02">V12 업데이트 실행</button>
                        <span class="help_txt">콘텐츠 성과(post_performance) 및 스냅샷 추가</span>
                    </td>
                </tr>
