...
<div class="local_desc01 local_desc">
    ...
    <p>Phase 1(광고주/사이트/발행 파이프라인 11개 테이블): <?php echo $v1_installed ? '설치됨' : '<span style="color:#c00;">미설치</span>'; ?>
        &nbsp;&nbsp;Phase 2(제목 후보/품질 검사 등):
        <?php echo $v2_installed ? '설치됨' : '<span style="color:#c00;">미설치</span>'; ?></p>
</div>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo get_text($diagnostics['php_version']); ?></td>
            </tr>
            <tr>
                <th scope="row">DB 서버 버전</th>
                <td><?php echo get_text($diagnostics['db_version']); ?></td>
            </tr>
            <tr>
                <th scope="row">DB 기본 문자셋 / Collation</th>
                <td><?php echo get_text($diagnostics['db_charset_default']); ?> /
                    <?php echo get_text($diagnostics['db_collation_default']); ?></td>
            </tr>
            <tr>
                <th scope="row">이번 연결의 문자셋</th>
                <td><?php echo get_text($diagnostics['connection_charset']); ?><?php echo $diagnostics['connection_charset'] === 'utf8mb4' ? ' (정상)' : ' <span style="color:#c00;">— utf8mb4가 아닙니다</span>'; ?>
                </td>
            </tr>
            <tr>
                <th scope="row">mysqli 클라이언트</th>
                <td><?php echo get_text($diagnostics['mysqli_client_version']); ?></td>
            </tr>
            <tr>
                <th scope="row">필수 확장</th>
                <td>
...
<?php } elseif ($did_install) { ?>
    <div class="local_desc01 local_desc" style="margin-top:15px;">
        <p>다음 테이블을 생성했습니다(이미 존재하면 건너뜁니다). 원본 DDL: <code>adm/blog/sql/blog_automation_v1.sql</code>,
            <code>adm/blog/sql/blog_automation_v2.sql</code></p>
        <ul>
