    ...
    <table>
        ...
        <tbody>
            <tr><th scope="row">제목</th>
                <td>
                    <form method="post" action="./project_action.php" onsubmit="return confirm('제목을 수정하시겠습니까?');">
                        <input type="hidden" name="id" value="<?php echo (int)$id; ?>">
            ...
            <tr><th scope="row">본문(현재)</th>
                <td>
                    <form method="post" action="./project_action.php" onsubmit="return confirm('본문을 수정하시겠습니까?');">
                        <input type="hidden" name="id" value="<?php echo (int)$id; ?>">
