...
<form name="fsiteform" method="post" action="<?php echo G5_ADMIN_URL; ?>/blog/site_update.php" onsubmit="return fsiteform_submit(this);">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr><th scope="row">연동 실행</th>
                <td>
                    <form method="post" action="<?php echo G5_ADMIN_URL; ?>/blog/naver_oauth_start.php" style="display:inline;">
                        <input type="hidden" name="token" value="<?php echo get_admin_token(); ?>">
