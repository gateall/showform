    ...
    <?php if (count($list) > 0) { ?>
        ...
        <div class="bp-project-card">
            ...
            <div class="bp-project-actions">
                ...
                <a href=G5_ADMIN_URL . "/blog/advertiser_delete.php?id=<?php echo (int) $row['id']; ?>&amp;token=<?php echo get_admin_token(); ?>" class="btn btn_01" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
            </div>
        </div>
        <?php } ?>
    <?php } else { ?>
