...
<form name="floglist" id="floglist" method="post" action="<?php echo G5_ADMIN_URL; ?>/landing/ai_log_delete.php">
<div class="list_actions">
    ...
    <div>
        ...
        <button type="button" class="btn btn_01" style="background:#10b981; color:#fff; border:none;" onclick="location.href=G5_ADMIN_URL . '/landing/ai_log_excel.php?<?php echo $_SERVER['QUERY_STRING']; ?>'">엑셀 다운로드</button>
    </div>
</div>
