...
if ($mode === 'form') {
    ...
    <form name="fpromptform" method="post" action="<?php echo G5_ADMIN_URL; ?>/landing/ai_prompt_update.php" onsubmit="return fpromptform_submit(this);">
    ...
    <form id="fpromptlist" method="post" action="<?php echo G5_ADMIN_URL; ?>/landing/ai_prompt_delete.php">
