...
<form name="fcategoryform" method="post" action="<?php echo G5_ADMIN_URL; ?>/landing/category_update.php" onsubmit="return fcategoryform_submit(this);">
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <?php if ($id > 0) { ?>
            <a href=G5_ADMIN_URL . "/landing/category_delete.php?id=<?php echo (int)$id; ?>&amp;token=<?php echo get_admin_token(); ?>" class="btn btn_01" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
        <?php } ?>
    </div>
</form>
