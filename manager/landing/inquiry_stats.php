...
<div class="stats_wrap">
    ...
    <div style="margin-top:20px; text-align:right;">
        <a href=G5_ADMIN_URL . "/landing/inquiry_stats_excel.php?fr_date=<?php echo $fr_date; ?>&to_date=<?php echo $to_date; ?>" class="btn_submit btn" style="background:#10b981;">통계 엑셀 다운로드</a>
    </div>
