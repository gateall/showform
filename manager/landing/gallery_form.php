...
<form name="fgalleryform" method="post" action="<?php echo G5_ADMIN_URL; ?>/landing/gallery_update.php" enctype="multipart/form-data">
...
<div class="sf-card">
    <div class="sf-grid">
        ...
        <div class="sf-field">
            ...
            <?php if (!empty($row['image_path'])) { ?><p style="margin-top:8px;"><a href="<?php echo get_text($row['image_path']); ?>" target="_blank"><?php echo get_text($row['image_path']); ?></a></p><?php } ?>
        </div>
        <div class="sf-field">
            <label>정렬 순서</label>
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <a href="./gallery_list.php" class="btn btn_02">목록</a>
    </div>
</div>
</form>
