...
<div class="memo_wrap" style="max-width:800px;">
    <!-- 메모 입력 폼 -->
    <form name="fmemo" method="post" action="<?php echo G5_ADMIN_URL; ?>/landing/inquiry_memo_update.php" style="margin-bottom:20px; padding:20px; background:#f0fdf4; border:1px solid #bbf7d0; border-radius:8px;">
