...
{
    if ($return === 'manager') {
        return SF_MANAGER_URL . '/showform/form.php?id=' . $id;
    }
    return SF_MANAGER_URL . '/showform/portfolio_form.php?id=' . $id;
}
...
if ($id > 0) {
    ...
    if (!$existing) {
        alert('제작 사례를 찾을 수 없습니다.', SF_MANAGER_URL . '/showform/portfolio_list.php');
    }
